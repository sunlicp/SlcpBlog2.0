...
export const wallType = [{
    name : '留言墙',
    slogan : '时光的延续淡漠了我们很多的人生记忆，让我们将快乐幸福的感觉永远地留存下来。'
},{
    name : '照片墙',
    slogan : '每一段记忆，都有一个密码。只要时间，地点，人物组合正确，无论尘封多久，那人那景都将在遗忘中重新拾起。'
}]
//分类标签
export const label = [
...
export const none = [
    {
        url : 'https://img.slcp.top/card.svg',
        msg : '还没有留言，快贴上第一张吧'
    },
    {
        url : 'https://img.slcp.top/photo.svg',
        msg : '还没有照片，快贴上第一张吧'
    }
]
// //开发环境配置
