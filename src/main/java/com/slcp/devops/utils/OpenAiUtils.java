...
import com.slcp.devops.entity.openai.OpenAi;
...
/**
 * @author slcp
 * @date 2023-01-10 22:30:21
 * @deprecated 已废弃，请使用新的 {@link com.slcp.devops.service.AiChatService} 代替
...
public class OpenAiUtils {
    ...
    public static List<String> OPENAPI_TOKEN = Collections.singletonList("");
...
/**
    ...
    public static List<CompletionChoice> getAiResult(OpenAi openAi, String prompt) {
        ...
        OpenAiService service = new OpenAiService(OPENAPI_TOKEN.get(0), TIMEOUT);
